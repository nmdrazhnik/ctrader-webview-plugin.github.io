(() => {
  ...
  // node_modules/@spotware-web-team/sdk-external-api/dist/index.mjs
  ...
  var sendRequest = (adapter, message, meta) => {
    const clientMsgId = message.clientMsgId ? message.clientMsgId : v4_default();
  ...
  // node_modules/@spotware-web-team/sdk/dist/index.mjs
  ...
  var require_Subscriber = __commonJS({
    "node_modules/rxjs/dist/cjs/internal/Subscriber.js"(exports) {
      ...
      var Subscriber2 = function(_super) {
        __extends2(Subscriber22, _super);
      ...
      var SafeSubscriber2 = function(_super) {
        __extends2(SafeSubscriber22, _super);
    ...
    "node_modules/rxjs/dist/cjs/internal/Observable.js"(exports) {
      ...
      var Observable3 = function() {
        ...
        Observable4.prototype.subscribe = function(observerOrNext, error, complete) {
          var _this = this;
          var subscriber = isSubscriber2(observerOrNext) ? observerOrNext : new Subscriber_1.SafeSubscriber(observerOrNext, error, complete);
  ...
  var require_OperatorSubscriber = __commonJS({
    "node_modules/rxjs/dist/cjs/internal/operators/OperatorSubscriber.js"(exports) {
      ...
      var OperatorSubscriber2 = function(_super) {
        __extends2(OperatorSubscriber22, _super);
        function OperatorSubscriber22(destination, onNext, onComplete, onError, onFinalize, shouldUnsubscribe) {
          var _this = _super.call(this, destination) || this;
          _this.onFinalize = onFinalize;
          _this.shouldUnsubscribe = shouldUnsubscribe;
          _this._next = onNext ? function(value) {
        ...
        OperatorSubscriber22.prototype.unsubscribe = function() {
          var _a;
          if (!this.shouldUnsubscribe || this.shouldUnsubscribe()) {
            var closed_1 = this.closed;
            _super.prototype.unsubscribe.call(this);
  ...
  var require_Subject = __commonJS({
    "node_modules/rxjs/dist/cjs/internal/Subject.js"(exports) {
      ...
      var AnonymousSubject2 = function(_super) {
        __extends2(AnonymousSubject22, _super);
  ...
  var getServerData = (transport, payload, multiple = false) => {
    const observer = transport.send({
      payloadType: 2100,
      payload,
      clientMsgId: v4_default()
    });
    if (!multiple) {
      return observer.pipe((0, import_rxjs4.take)(1));
    }
    return observer;
  };
  var registerEvent = (transport) => {
    return transport.event$.pipe(
      (0, import_rxjs4.filter)(
        (message) => message.payloadType === 2e3
        /* RegisterEvent */
      ),
      (0, import_rxjs4.map)((message) => message.payload)
    );
  };
  var handleConfirmEvent = (transport, payload) => {
    return transport.send(confirmEventData(payload, v4_default()), { completed: true }).pipe(
  ...
  var serverDataEvent = (transport) => {
    return transport.event$.pipe(
      (0, import_rxjs4.filter)(
        (message) => message.payloadType === 2102
        /* ServerDataEvent */
      ),
      (0, import_rxjs4.map)((message) => message.payload)
    );
  ...
  var quoteEvent = (transport) => {
    return serverDataEvent(transport).pipe(
      (0, import_rxjs22.map)((event) => {
        return JSON.parse(event.data);
      }),
      (0, import_rxjs22.filter)(
        (message) => message.payloadType === 3
        /* QuoteEvent */
      ),
      (0, import_rxjs22.map)((event) => {
  ...
  <div style="margin-top:8px">
    ...
    $("#sub").onclick = () => {
      ...
      qsub = quoteEvent(adapter, { symbolName: sym }).subscribe((q) => {
    ...
    $("#unsub").onclick = () => {
      ...
      try {
        ...
        L("unsubscribe error: " + (e.message || e));
      }
    };
  })();
})();
